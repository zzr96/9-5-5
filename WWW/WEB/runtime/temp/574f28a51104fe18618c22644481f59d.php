<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\phpStudy\PHPTutorial\WWW\WEB\public_html/../application/admin\view\kd\index.html";i:1553012160;s:71:"D:\phpStudy\PHPTutorial\WWW\WEB\application\admin\view\common\head.html";i:1551318104;s:71:"D:\phpStudy\PHPTutorial\WWW\WEB\application\admin\view\common\menu.html";i:1537404906;s:71:"D:\phpStudy\PHPTutorial\WWW\WEB\application\admin\view\common\foot.html";i:1541491608;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class='bd'>
        <div class="v_tishi">
            ...
            <p style='float:right;margin-top:4px;'>
                <a href="<?php echo url('add'); ?>?nav=添加快递" class="btn btn-success">添加快递</a>
            </p>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table">
            ...
            <tr>
                ...
                <td><img src="/public_html<?php echo $vo['logo']; ?>" style="height:50px;width:50px;"></td>
                <td>
                    <a href="<?php echo url('edit'); ?>?id=<?php echo $vo['id']; ?>&nav=编辑快递信息" class="btn btn-primary">编辑</a>
