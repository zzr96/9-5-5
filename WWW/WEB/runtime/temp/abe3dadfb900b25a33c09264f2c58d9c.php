<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:93:"D:\phpStudy\PHPTutorial\WWW\WEB\public_html/../application/admin\view\administrator\edit.html";i:1552379470;s:71:"D:\phpStudy\PHPTutorial\WWW\WEB\application\admin\view\common\head.html";i:1551318104;s:71:"D:\phpStudy\PHPTutorial\WWW\WEB\application\admin\view\common\menu.html";i:1537404906;s:71:"D:\phpStudy\PHPTutorial\WWW\WEB\application\admin\view\common\foot.html";i:1541491608;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<form action="<?php echo url("edit_do"); ?>" method="post" id="form">
	  <input name="id" type="hidden" value="<?php echo $view['id']; ?>" />
	  			<div class="item">
					<label>用户名：</label>
					<div class="i_bd">
					<input type="text"  value="<?php echo $view['name']; ?>" disabled="disabled" class="edit_input" size="60" /> 
					</div>
				</div>
				...
				<div class="item">
					...
					<select name="cat" id="cat" >
					  ...
					  <option value="<?php echo $vo['id']; ?>"  <?php if($view["cat"]==$vo["id"]){echo 'selected="selected"';} ?> ><?php echo $vo['name']; ?></option>
					  <?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
					</div>
				</div>
				...
				<div class="item">
					<label>密码：</label>
					<div class="i_bd">
					<input type="text" id="password" name="password" class="edit_input" size="60" value="<?php echo $view['pass']; ?>" /> <span>（留空不做修改）</span>
					</div>
				</div>
				...
				<div class="item">
					<label>确认密码：</label>
					<div class="i_bd">
					<input type="text" id="title" name="repassword" class="edit_input" size="60" value="<?php echo $view['pass']; ?>"/>
					</div>
				</div>
				...
				<div class="item">
					<label>姓名：</label>
					<div class="i_bd">
					<input type="text" id="title" name="xingming" value="<?php echo $view['xingming']; ?>" class="edit_input" size="60" /> 
					</div>
				</div>
				<div class="item">
					<label>电话：</label>
					<div class="i_bd">
					<input type="text" id="title" name="dianhua" value="<?php echo $view['dianhua']; ?>" class="edit_input" size="60" /> 
					</div>
				</div>
				...
				<div class="item">
					<label>启用：</label>
					<div class="i_bd">
					是<input name="status" type="radio" value="1"  <?php if($view['status']==1){echo 'checked="checked"';} ?> /> 否<input name="status" type="radio" value="2"  <?php if($view['status']==2){echo 'checked="checked"';} ?>  />
					</div>
				</div>
